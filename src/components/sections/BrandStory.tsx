export default function BrandStory() {
  return (
    <section id="story" className="bg-[#131210] px-12 py-28">
      <div className="max-w-[1000px] mx-auto grid grid-cols-2 gap-20 items-center">
        {/* Media */}
        <div className="relative">
          <div className="w-full aspect-[3/4] bg-[#1a1916] flex items-center justify-center">
            <span className="text-[100px] opacity-30 select-none">🪡</span>
          </div>
          {/* Accent border */}
          <div className="absolute -bottom-6 -right-6 w-[60%] h-[60%] border border-[#c8a96e] pointer-events-none" />
        </div>

        {/* Text */}
        <div>
          <p className="text-[10px] tracking-[0.3em] uppercase text-[#c8a96e] mb-5">Câu chuyện của chúng tôi</p>
          <h2 className="font-serif text-[48px] font-light leading-[1.15] mb-7">
          ...
          <p className="text-[15px] text-muted leading-[1.9] mb-10">
          ...
          <p className="font-serif italic text-[28px] text-[#c8a96e]">Nguyễn Minh Châu</p>
